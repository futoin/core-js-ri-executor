...
exports.SecurityProvider = require( '../SecurityProvider' );
exports.LegacySecurityProvider = require( '../LegacySecurityProvider' );

exports.PingService = require( '../PingService' );
...
if ( isNode ) {
    const mod = module;
    exports.NodeExecutor = mod.require( '../NodeExecutor' );
} else {
