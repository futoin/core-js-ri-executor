...
exports.RequestInfo.prototype =
{
    ...
    rawInput : function()
    {
        if ( ( this._rawinp === null ) &&
             ( this,_info[ INFO_CHANNEL_CONTEXT ] !== null ) )
        {
            this._rawinp = this._info[ INFO_CHANNEL_CONTEXT ].openRawInput();
        }
    ...
    rawOutput : function()
    {
        if ( ( this._rawout === null ) &&
             ( this,_info[ INFO_CHANNEL_CONTEXT ] !== null ) )
        {
            this._rawout = this._info[ INFO_CHANNEL_CONTEXT ].openRawOutput();
        }
