...
exports.RequestInfo.prototype =
{
    ...
    rawInput : function()
    {
        if ( this._info[ this.INFO_HAVE_RAW_UPLOAD ] &&
             ( this._rawinp === null ) &&
             ( this._info[ this.INFO_CHANNEL_CONTEXT ] !== null ) )
        {
            this._rawinp = this._info[ this.INFO_CHANNEL_CONTEXT ].openRawInput();
        }
    ...
    rawOutput : function()
    {
        if ( this._info[ this.INFO_HAVE_RAW_RESULT ] &&
             ( this._rawout === null ) &&
             ( this._info[ this.INFO_CHANNEL_CONTEXT ] !== null ) )
        {
            this._rawout = this._info[ this.INFO_CHANNEL_CONTEXT ].openRawOutput();
        }
