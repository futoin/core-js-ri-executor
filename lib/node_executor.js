...
node_executor.prototype =
{
    _http_server : null,
    _http_path : null,
    _ws : null,

    handleHTTPRequest : function( req, rsp )
    {
        var _this = this;
        var data = [];
    ...
    _handleHTTPRequestCommon : function( reqinfo, req, rsp, raw_upload )
    {
    ...
    handleWSConnection : function( ws )
    {
        var _this = this;
    ...
    _handleWSRequest : function( context, req )
    {
        var reqinfo = new request.RequestInfo( _this, req );
...
_.extend( node_executor, node_executor_const );
_.extend( node_executor.prototype, node_executor_const );
_.extend( node_executor.prototype, events.EventEmitter.prototype );
node_executor.prototype.prototype = executor.prototype;

exports = module.exports = node_executor;
